...
var resourceCategories = map[string][]string{
	...
	"organization-invoices-batch-file-exports": {CatOrganizations},
	"organization-invoices-batch-invoices":     {CatOrganizations},
	"organization-invoices-batch-invoice-status-changes": {CatOrganizations},
	"organization-invoices-batch-pdf-templates":          {CatOrganizations},
	"organization-project-actuals-exports":               {CatOrganizations},
	"truckers":                                           {CatOrganizations, CatFleet}, // appears in both
	"trucker-applications":                               {CatOrganizations, CatFleet},
	"trucker-referral-codes":                             {CatOrganizations, CatFleet},
	...
	"posts":                   {CatContent},
	"post-actions":            {CatContent},
	"post-children":           {CatContent},
	"post-views":              {CatContent},
	"press-releases":          {CatContent},
	"marketing-metrics":       {CatContent},
	"release-notes":           {CatContent},
	"questions":               {CatContent},
	"ui-tour-steps":           {CatContent},
	"user-ui-tours":           {CatContent},

	// Projects & Jobs
	"action-items":                                                 {CatProjects},
	"incident-headline-suggestions":                                {CatProjects},
	"incident-tag-incidents":                                       {CatProjects},
	"incident-request-cancellations":                               {CatProjects},
	"crew-assignment-confirmations":                                {CatProjects},
	"crew-requirements":                                            {CatProjects},
	"equipment-requirements":                                       {CatProjects},
	"job-production-plan-cancellation-reason-types":                {CatProjects},
	"job-production-plan-alarm-subscribers":                        {CatProjects},
	"job-production-plan-subscriptions":                            {CatProjects},
	"job-production-plan-change-sets":                              {CatProjects},
	"job-production-plan-material-transaction-summaries":           {CatProjects},
	"job-production-plan-scrappages":                               {CatProjects},
	"job-production-plan-unapprovals":                              {CatProjects},
	"job-production-plan-safety-risks":                             {CatProjects},
	"job-production-plans":                                         {CatProjects},
	"jobs":                                                         {CatProjects},
	"job-sites":                                                    {CatProjects},
	"lineup-job-schedule-shift-trucker-assignment-recommendations": {CatProjects},
	"lineup-scenario-lineups":                                      {CatProjects},
	"lineup-scenario-truckers":                                     {CatProjects},
	"built-time-cards":                                             {CatProjects},
	"down-minutes-estimates":                                       {CatProjects},
	"shift-time-card-requisitions":                                 {CatProjects},
	"time-cards":                                                   {CatProjects},
	"time-card-submissions":                                        {CatProjects},
	"time-card-approvals":                                          {CatProjects},
	"time-card-rejections":                                         {CatProjects},
	"time-sheets-exports":                                          {CatProjects},
	"process-non-processed-time-card-time-changes":                 {CatProjects},
	"tender-cancellations":                                         {CatProjects},
	"tender-status-changes":                                        {CatProjects},
	"invoice-exports":                                              {CatProjects},
	...
	"prediction-subject-memberships":                               {CatProjects},
	"prediction-subject-recaps":                                    {CatProjects},
	"prediction-knowledge-base-questions":                          {CatProjects},
	"project-categories":                                           {CatProjects},
	"project-divisions":                                            {CatProjects},
	"project-offices":                                              {CatProjects},
	"project-estimate-sets":                                        {CatProjects},
	"project-phase-dates-estimates":                                {CatProjects},
	"project-phase-cost-item-quantity-estimates":                   {CatProjects},
	"project-phase-revenue-item-quantity-estimates":                {CatProjects},
	"project-revenue-item-quantity-estimates":                      {CatProjects},
	"project-subscriptions":                                        {CatProjects},
	"projects":                                                     {CatProjects},
	"profit-improvements":                                          {CatProjects},
	"broker-retainers":                                             {CatProjects},
	"broker-tender-offered-seller-notifications":                   {CatProjects},
	"broker-tender-offered-seller-notification-subscriptions":      {CatProjects},
	"customer-tender-offered-buyer-notification-subscriptions":     {CatProjects},
	"tender-job-schedule-shift-fill-out-time-card-seller-notifications": {CatProjects},
	"shift-acknowledgement-reminder-notification-subscriptions":         {CatProjects},
	...
	"project-transport-locations":                       {CatFleet},
	"project-transport-plans":                           {CatFleet},
	"project-transport-plan-drivers":                    {CatFleet},
	"project-transport-plan-strategy-sets":              {CatFleet},
	"tractors":                                          {CatFleet},
	"trailers":                                          {CatFleet},
	"transport-order-materials":                         {CatFleet},
	"transport-orders":                                  {CatFleet},
	"transport-references":                              {CatFleet},
	"vehicle-location-events":                           {CatFleet},
	...
	"cost-code-trucking-cost-summaries": {CatClassifications},
