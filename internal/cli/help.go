...
var resourceCategories = map[string][]string{
	...
	"prediction-knowledge-base-answers": {CatOrganizations},
	...
	"trucker-application-approvals":     {CatOrganizations},
	...
	"native-app-releases":   {CatContent},
	...
	"action-item-line-items":                          {CatProjects},
	"crew-assignment-confirmations":                   {CatProjects},
	"invoice-approvals":                               {CatProjects},
	"invoice-sends":                                   {CatProjects},
	"invoice-pdf-emails":                              {CatProjects},
	...
	"job-production-plan-recap-generations":           {CatProjects},
	"job-production-plan-schedule-changes":            {CatProjects},
	"job-production-plan-rejections":                  {CatProjects},
	"job-production-plan-unabandonments":              {CatProjects},
	"time-card-scrappages":                            {CatProjects},
	"time-sheet-approvals":                            {CatProjects},
	"time-sheet-no-shows":                             {CatProjects},
	"tender-rejections":                               {CatProjects},
	"job-production-plans":                            {CatProjects},
	"job-sites":                                       {CatProjects},
	"lineup-scenario-solutions":                       {CatProjects},
	"lineup-summary-requests":                         {CatProjects},
	"project-categories":                              {CatProjects},
	"project-divisions":                               {CatProjects},
	"project-bid-location-material-types":             {CatProjects},
	"project-material-types":                          {CatProjects},
	"project-customers":                               {CatProjects},
	"project-truckers":                                {CatProjects},
	"project-import-file-verifications":               {CatProjects},
	"project-offices":                                 {CatProjects},
	"project-transport-organizations":                 {CatProjects},
	"project-revenue-items":                           {CatProjects},
	"profit-improvement-subscriptions":                {CatProjects},
	"projects":                                        {CatProjects},

	// Fleet & Transport
	"driver-day-constraints":                       {CatFleet},
	"driver-movement-segment-sets":                 {CatFleet},
	"equipment-movement-requirements":              {CatFleet},
	"equipment-movement-trip-job-production-plans": {CatFleet},
	"hos-ruleset-assignments":                      {CatFleet},
	"project-transport-plan-events":                {CatFleet},
	"project-transport-plan-stop-insertions":       {CatFleet},
	"project-transport-plan-segment-drivers":       {CatFleet},
	...
	// Materials
	"material-site-inventory-locations":                          {CatMaterials},
	...
	"tender-job-schedule-shifts-material-transactions-checksums": {CatMaterials},
	...
	"project-project-cost-classifications":            {CatClassifications},
