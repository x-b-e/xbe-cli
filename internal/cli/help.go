...
var resourceCategories = map[string][]string{
	...
	"driver-day-adjustments":                                         {CatProjects},
	"job-production-plan-cost-codes":                                 {CatProjects},
	"job-production-plan-cancellation-reason-types":                  {CatProjects},
	"job-production-plan-inspectors":                                 {CatProjects},
	"job-production-plan-material-type-quality-control-requirements": {CatProjects},
	"job-production-plan-safety-risks-suggestions":                   {CatProjects},
	"job-production-plan-submissions":                                {CatProjects},
	"job-production-plan-trucking-incident-detectors":                {CatProjects},
	"job-production-plans":                                           {CatProjects},
	"job-schedule-shift-is-managed-toggles":                          {CatProjects},
	"job-sites":                                                      {CatProjects},
	"lineup-job-production-plans":                                    {CatProjects},
	"lineup-scenario-lineup-job-schedule-shifts":                     {CatProjects},
	"lineup-scenario-trailers":                                       {CatProjects},
	...
	"time-sheet-submissions":                                         {CatProjects},
	"time-sheet-unsubmissions":                                       {CatProjects},

	// Fleet & Transport
	"equipment-suppliers": {CatFleet},
	"hos-annotations":     {CatFleet},
	"maintenance-requirement-rule-maintenance-requirement-sets": {CatFleet},
	"tractors": {CatFleet},
	"trailers": {CatFleet},
	"transport-order-project-transport-plan-strategy-set-predictions": {CatFleet},
	"transport-order-stops": {CatFleet},
	...
	"material-transaction-denials":   {CatMaterials},
