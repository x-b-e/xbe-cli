...
var resourceCategories = map[string][]string{
	...
	"action-item-team-members":                           {CatProjects},
	"crew-assignment-confirmations":                      {CatProjects},
	"work-order-assignments":                             {CatProjects},
	"job-production-plan-abandonments":                   {CatProjects},
	"job-production-plan-completions":                    {CatProjects},
	...
	"invoice-revisionables":                              {CatProjects},
	"invoice-revisionizings":                             {CatProjects},
	"lineup-dispatch-fulfillment-clerks":                 {CatProjects},
	"lineup-dispatch-statuses":                           {CatProjects},
	"lineups":                                            {CatProjects},
	"meetings":                                           {CatProjects},
	"lineup-scenario-trailer-lineup-job-schedule-shifts": {CatProjects},
	"broker-tenders":                                     {CatProjects},
	"customer-tenders":                                   {CatProjects},
	"shift-scope-tenders":                                {CatProjects},
	"tender-job-schedule-shifts":                         {CatProjects},
	"tender-returns":                                     {CatProjects},
	"project-abandonments":                               {CatProjects},
	"project-cancellations":                              {CatProjects},
	"project-completions":                                {CatProjects},
	"project-duplications":                               {CatProjects},
	"project-categories":                                 {CatProjects},
	"project-divisions":                                  {CatProjects},
	"project-offices":                                    {CatProjects},
	"project-phase-revenue-items":                        {CatProjects},
	"project-actuals-exports":                            {CatProjects},
	"project-phase-revenue-item-actual-exports":          {CatProjects},
	"projects":                                           {CatProjects},
	"time-card-time-changes":                             {CatProjects},
	"time-card-invoices":                                 {CatProjects},
	...
	"samsara-integrations":                                {CatFleet},
	"trucker-shift-sets":                                  {CatFleet},
	"tractors":                                            {CatFleet},
	"trailers":                                            {CatFleet},
	"transport-orders":                                    {CatFleet},
	"user-location-estimates":                             {CatFleet},
	...
	"objective-stakeholder-classifications":                {CatClassifications},
	...
	"resource-classification-project-cost-classifications": {CatClassifications},
